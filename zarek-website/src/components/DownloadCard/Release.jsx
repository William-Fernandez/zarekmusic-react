...
export default function DownloadCards({
    ...
    return (
        <div
            className="backdrop-blur-lg rounded-xl w-72 lg:w-80 h-[390px] lg:h-[450px] mx-7 my-8 p-4 flex flex-col justify-between items-center transition duration-300 hover:scale-105 overflow-hidden relative outline outline-white/10 outline-1"
            style={cardStyle}
        >
