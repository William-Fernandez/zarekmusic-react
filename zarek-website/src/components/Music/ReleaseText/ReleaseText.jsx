...
export default function ReleaseText() {
    return (
        <div className="flex flex-col items-center md:items-start md:justify-center mt-5 md:my-0 h-max lg:h-2/4 lg:py-6 px-4 md:px-12 bg-black/70 backdrop-blur-sm md:rounded-[0_50px_50px_0] md:border-r-2">
            ...
            <strong className="text-[#E23C4A]">The Vox</strong> is a fresh collaboration between <strong className="text-[#E23C4A]">Zarek</strong> and <strong className="text-[#E23C4A]">Felipe M</strong>. Released by <strong className="text-[#E23C4A]">Sojos</strong> as part of the "<strong className="text-[#E23C4A]">Chapter Three VA 2025</strong>" compilation. The track blends crisp percussion and rolling grooves with subtle vocal chops that give it its name, offering a clean and energetic sound built for the dancefloor.<br />
